 ...
 */
@ApiModel(description = "Message that is sent whenever an ExternalTask lock expires.")
@JsonPropertyOrder({
  ExternalTaskUnlockedMessage.JSON_PROPERTY_CORRELATION_ID,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_PROCESS_DEFINITION_ID,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_PROCESS_MODEL_ID,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_PROCESS_MODEL_NAME,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_PROCESS_INSTANCE_ID,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_PARENT_PROCESS_INSTANCE_ID,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_FLOW_NODE_ID,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_FLOW_NODE_NAME,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_FLOW_NODE_TYPE,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_FLOW_NODE_INSTANCE_ID,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_OWNER_ID,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_PREVIOUS_FLOW_NODE_INSTANCE_ID,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_CURRENT_TOKEN,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_EVENT_TYPE,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_EVENT_NAME,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_CUSTOM_CORRELATION_ID,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_EXTERNAL_TASK_ID,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_TOPIC,
  ExternalTaskUnlockedMessage.JSON_PROPERTY_IS_SINGLE_TRY
})
...
public class ExternalTaskUnlockedMessage {
  ...
  public ExternalTaskUnlockedMessage correlationId(String correlationId) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage processDefinitionId(String processDefinitionId) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage processModelId(String processModelId) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage processModelName(String processModelName) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage processInstanceId(String processInstanceId) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage parentProcessInstanceId(String parentProcessInstanceId) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage flowNodeId(String flowNodeId) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage flowNodeName(String flowNodeName) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage flowNodeType(BpmnType flowNodeType) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage flowNodeInstanceId(String flowNodeInstanceId) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage ownerId(String ownerId) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage previousFlowNodeInstanceId(String previousFlowNodeInstanceId) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage currentToken(Object currentToken) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage eventType(EventType eventType) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage eventName(String eventName) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage customCorrelationId(String customCorrelationId) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage externalTaskId(String externalTaskId) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage topic(String topic) {
  ...
  **/
  ...
  public ExternalTaskUnlockedMessage isSingleTry(Boolean isSingleTry) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ExternalTaskUnlockedMessage externalTaskUnlockedMessage = (ExternalTaskUnlockedMessage) o;
    return Objects.equals(this.correlationId, externalTaskUnlockedMessage.correlationId) &&
        Objects.equals(this.processDefinitionId, externalTaskUnlockedMessage.processDefinitionId) &&
        Objects.equals(this.processModelId, externalTaskUnlockedMessage.processModelId) &&
        Objects.equals(this.processModelName, externalTaskUnlockedMessage.processModelName) &&
        Objects.equals(this.processInstanceId, externalTaskUnlockedMessage.processInstanceId) &&
        Objects.equals(this.parentProcessInstanceId, externalTaskUnlockedMessage.parentProcessInstanceId) &&
        Objects.equals(this.flowNodeId, externalTaskUnlockedMessage.flowNodeId) &&
        Objects.equals(this.flowNodeName, externalTaskUnlockedMessage.flowNodeName) &&
        Objects.equals(this.flowNodeType, externalTaskUnlockedMessage.flowNodeType) &&
        Objects.equals(this.flowNodeInstanceId, externalTaskUnlockedMessage.flowNodeInstanceId) &&
        Objects.equals(this.ownerId, externalTaskUnlockedMessage.ownerId) &&
        Objects.equals(this.previousFlowNodeInstanceId, externalTaskUnlockedMessage.previousFlowNodeInstanceId) &&
        Objects.equals(this.currentToken, externalTaskUnlockedMessage.currentToken) &&
        Objects.equals(this.eventType, externalTaskUnlockedMessage.eventType) &&
        Objects.equals(this.eventName, externalTaskUnlockedMessage.eventName) &&
        Objects.equals(this.customCorrelationId, externalTaskUnlockedMessage.customCorrelationId) &&
        Objects.equals(this.externalTaskId, externalTaskUnlockedMessage.externalTaskId) &&
        Objects.equals(this.topic, externalTaskUnlockedMessage.topic) &&
        Objects.equals(this.isSingleTry, externalTaskUnlockedMessage.isSingleTry);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExternalTaskUnlockedMessage {\n");
