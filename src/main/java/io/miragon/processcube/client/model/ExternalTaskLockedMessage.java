...
import io.miragon.processcube.client.model.ExternalTaskLockedMessageAllOf;
 ...
 */
@ApiModel(description = "Message that is sent whenever an ExternalTask was locked by a worker.")
@JsonPropertyOrder({
  ExternalTaskLockedMessage.JSON_PROPERTY_CORRELATION_ID,
  ExternalTaskLockedMessage.JSON_PROPERTY_PROCESS_DEFINITION_ID,
  ExternalTaskLockedMessage.JSON_PROPERTY_PROCESS_MODEL_ID,
  ExternalTaskLockedMessage.JSON_PROPERTY_PROCESS_MODEL_NAME,
  ExternalTaskLockedMessage.JSON_PROPERTY_PROCESS_INSTANCE_ID,
  ExternalTaskLockedMessage.JSON_PROPERTY_PARENT_PROCESS_INSTANCE_ID,
  ExternalTaskLockedMessage.JSON_PROPERTY_FLOW_NODE_ID,
  ExternalTaskLockedMessage.JSON_PROPERTY_FLOW_NODE_NAME,
  ExternalTaskLockedMessage.JSON_PROPERTY_FLOW_NODE_TYPE,
  ExternalTaskLockedMessage.JSON_PROPERTY_FLOW_NODE_INSTANCE_ID,
  ExternalTaskLockedMessage.JSON_PROPERTY_OWNER_ID,
  ExternalTaskLockedMessage.JSON_PROPERTY_PREVIOUS_FLOW_NODE_INSTANCE_ID,
  ExternalTaskLockedMessage.JSON_PROPERTY_CURRENT_TOKEN,
  ExternalTaskLockedMessage.JSON_PROPERTY_EVENT_TYPE,
  ExternalTaskLockedMessage.JSON_PROPERTY_EVENT_NAME,
  ExternalTaskLockedMessage.JSON_PROPERTY_CUSTOM_CORRELATION_ID,
  ExternalTaskLockedMessage.JSON_PROPERTY_EXTERNAL_TASK_ID,
  ExternalTaskLockedMessage.JSON_PROPERTY_TOPIC,
  ExternalTaskLockedMessage.JSON_PROPERTY_IS_SINGLE_TRY,
  ExternalTaskLockedMessage.JSON_PROPERTY_WORKER_ID,
  ExternalTaskLockedMessage.JSON_PROPERTY_LOCK_EXPIRATION_TIME
})
...
public class ExternalTaskLockedMessage {
  ...
  public ExternalTaskLockedMessage correlationId(String correlationId) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage processDefinitionId(String processDefinitionId) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage processModelId(String processModelId) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage processModelName(String processModelName) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage processInstanceId(String processInstanceId) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage parentProcessInstanceId(String parentProcessInstanceId) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage flowNodeId(String flowNodeId) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage flowNodeName(String flowNodeName) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage flowNodeType(BpmnType flowNodeType) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage flowNodeInstanceId(String flowNodeInstanceId) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage ownerId(String ownerId) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage previousFlowNodeInstanceId(String previousFlowNodeInstanceId) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage currentToken(Object currentToken) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage eventType(EventType eventType) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage eventName(String eventName) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage customCorrelationId(String customCorrelationId) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage externalTaskId(String externalTaskId) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage topic(String topic) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage isSingleTry(Boolean isSingleTry) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage workerId(String workerId) {
  ...
  **/
  ...
  public ExternalTaskLockedMessage lockExpirationTime(String lockExpirationTime) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ExternalTaskLockedMessage externalTaskLockedMessage = (ExternalTaskLockedMessage) o;
    return Objects.equals(this.correlationId, externalTaskLockedMessage.correlationId) &&
        Objects.equals(this.processDefinitionId, externalTaskLockedMessage.processDefinitionId) &&
        Objects.equals(this.processModelId, externalTaskLockedMessage.processModelId) &&
        Objects.equals(this.processModelName, externalTaskLockedMessage.processModelName) &&
        Objects.equals(this.processInstanceId, externalTaskLockedMessage.processInstanceId) &&
        Objects.equals(this.parentProcessInstanceId, externalTaskLockedMessage.parentProcessInstanceId) &&
        Objects.equals(this.flowNodeId, externalTaskLockedMessage.flowNodeId) &&
        Objects.equals(this.flowNodeName, externalTaskLockedMessage.flowNodeName) &&
        Objects.equals(this.flowNodeType, externalTaskLockedMessage.flowNodeType) &&
        Objects.equals(this.flowNodeInstanceId, externalTaskLockedMessage.flowNodeInstanceId) &&
        Objects.equals(this.ownerId, externalTaskLockedMessage.ownerId) &&
        Objects.equals(this.previousFlowNodeInstanceId, externalTaskLockedMessage.previousFlowNodeInstanceId) &&
        Objects.equals(this.currentToken, externalTaskLockedMessage.currentToken) &&
        Objects.equals(this.eventType, externalTaskLockedMessage.eventType) &&
        Objects.equals(this.eventName, externalTaskLockedMessage.eventName) &&
        Objects.equals(this.customCorrelationId, externalTaskLockedMessage.customCorrelationId) &&
        Objects.equals(this.externalTaskId, externalTaskLockedMessage.externalTaskId) &&
        Objects.equals(this.topic, externalTaskLockedMessage.topic) &&
        Objects.equals(this.isSingleTry, externalTaskLockedMessage.isSingleTry) &&
        Objects.equals(this.workerId, externalTaskLockedMessage.workerId) &&
        Objects.equals(this.lockExpirationTime, externalTaskLockedMessage.lockExpirationTime);
  }

  @Override
  public int hashCode() {
    return Objects.hash(correlationId, processDefinitionId, processModelId, processModelName, processInstanceId, parentProcessInstanceId, flowNodeId, flowNodeName, flowNodeType, flowNodeInstanceId, ownerId, previousFlowNodeInstanceId, currentToken, eventType, eventName, customCorrelationId, externalTaskId, topic, isSingleTry, workerId, lockExpirationTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExternalTaskLockedMessage {\n");
